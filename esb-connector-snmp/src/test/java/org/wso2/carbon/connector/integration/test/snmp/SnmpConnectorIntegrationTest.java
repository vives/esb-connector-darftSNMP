...
public class SnmpConnectorIntegrationTest extends ConnectorIntegrationTestBase {
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpSet} integration test with mandatory parameters.")
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGet} integration test with mandatory parameters.")
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGet} integration test with optional parameters.")
	public void testSnmpGetWithOptionalParameters() throws IOException, JSONException {
		esbRequestHeadersMap.put("Action", "urn:snmpGet");
		RestResponse<JSONObject> esbRestResponse =
				sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
				                    "snmpGet_optional.json");
		Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
		Assert.assertEquals(true, esbRestResponse.getBody().toString().contains("Response"));
	}
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGetNext} integration test with mandatory" +
	                                    " parameters.")
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGetNext} integration test with optional" +
	                                    " parameters.")
	public void testSnmpGetNextWithOptionalParameters() throws IOException, JSONException {
		esbRequestHeadersMap.put("Action", "urn:snmpGetNext");
		RestResponse<JSONObject> esbRestResponse =
				sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
				                    "snmpGetNext_optional.json");
		Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
		Assert.assertEquals(true, esbRestResponse.getBody().toString().contains("Response"));
	}
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGetNext} integration test negative case.")
	public void testSnmpGetNextWithNegativeCase() throws IOException, JSONException {
		esbRequestHeadersMap.put("Action", "urn:snmpGetNext");
		RestResponse<JSONObject> esbRestResponse =
				sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
				                    "snmpGetNext_negative.json");
		Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 202);
	}
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGetBulk} integration test with mandatory" +
	                                    " parameters.")
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "snmp {snmpGetBulk} integration test negative case.")
	public void testSnmpGetBulkWithNegativeCase() throws IOException, JSONException {
		esbRequestHeadersMap.put("Action", "urn:snmpGetBulk");
		RestResponse<JSONObject> esbRestResponse =
				sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
				                    "snmpGetBulk_negative.json");
		Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 202);
	}
}